...
class ChangeTextTest {
    ...
    private val textToSpaceSet = ""
    private val defaultHeaderText = "Hello UiAutomator!"
...
//    }
    ...
    fun testChangeTextSpace() {
        ...
        device.findObject(By.res(packageName, "userInput")).text = textToSpaceSet
        device.findObject(By.res(packageName, "buttonChange")).click()

        val result = device.findObject(By.res(packageName, "textToBeChanged")).text
        assertEquals(result, defaultHeaderText)
    }

    @Test
    fun testTextOnAnotherActivity() {
        val packageName = MODEL_PACKAGE
        waitForPackage(packageName)
